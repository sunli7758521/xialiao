...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/aa.mp3**", "anon");
        ...
        /** 放行  顾问登录 添加 开单记录*/
        filterChainDefinitionMap.put("/record/record/login", "anon");
        filterChainDefinitionMap.put("/record/record/**", "anon");

        filterChainDefinitionMap.put("/record/record/add", "anon");
